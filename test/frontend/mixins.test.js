...
describe('Template Mixins', () => {
  ...
  describe('with stubbed Nunjucks', () => {
    ...
    xdescribe('input-amount-with-unit-select', () => {
      it('adds a function to res.locals', () => {
        middleware(req, res, next);
    ...
    xdescribe('maxlengthAttribute - input-text', () => {
      beforeEach(() => {
        render.resetHistory();
      });
  ...
  describe('without stubbed Nunjucks', () => {
    xit('looks up variables within the field key', () => {
      res.locals.foo = 'bar';
      res.locals.options.fields = {
        'bar-field-name': {}
      };
