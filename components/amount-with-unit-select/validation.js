 ...
 * @param {Object|Object[]|string|string[]|function(string): boolean|(function(string): boolean)[]} newValidator - The validator to add
 */
...
/**
 * Propagates the child component's (amount and unit) field data and values into the from request to enable validation.
 * 
...
/**
 * Moves validators, that are not the 'required' or 'equal' type, from the parent component to the 'amount' child component,
 ...
 * Only one error from the component is added to the request's error list in the order of the parent, amount, and then unit component.
 * 
 * @param {Object} req - The request object given to the component
 * @param {Object} res - The response object given to the component
 * @param {Object[]} errors - The validation errors recorded in the session model
