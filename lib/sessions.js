...
module.exports = (app, config) => {
  ...
  if (config.session.secret === 'changethis') {
    deprecate(
      'Default session encryption secret will be removed in a future version.',
      'Supply a unique, unguessable value to the environment as SESSION_SECRET.'
    );
  }
